...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/traceability-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-traceability-core:");
...
console.log("Documentation check passed for gutu-plugin-traceability-core.");
